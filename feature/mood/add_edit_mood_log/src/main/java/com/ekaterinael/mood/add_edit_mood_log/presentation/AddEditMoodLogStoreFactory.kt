...
constructor(
  ...
  fun create(moodLog: MoodLog): AddEditMoodLogStore {
    ...
    return object :
      AddEditMoodLogStore,
      Store<
        AddEditMoodLogStore.Intent,
        AddEditMoodLogStore.State,
        AddEditMoodLogStore.Label,
  ...
  private inner class ExecutorImpl :
    ...
    override fun executeIntent(
      ...
      when (intent) {
        is AddEditMoodLogStore.Intent.OnChangeDescription ->
          dispatch(Message.OnChangeDescription(intent.description))
  ...
  companion object {
    ...
    private class NoEditingModeException :
      IllegalStateException("Can change data only in editing mode")
  }
}
