...
val BadMood = Color(0xFFF2E0BA)
val AwfulMood = Color(0xFFEF9276)
val UnknownMood = Color(0xFFC0C0C0)

val lightBlue = Color(0xFFDAF7FF)
val lightPink = Color(0xFFEDE1FF)
val lightOrange = Color(0xFFFFE7D9)

val OldPaperBackground = Color(0xFFF8F2ED)
val GraphiteText = Color(0xFF444444)
val SoftIvorySurface = Color(0xFFFBFAF6)
val PaperCardBackground = Color(0xEDFFFAF5)
val AccentYellow = Color(0xFFFFBC2D)
